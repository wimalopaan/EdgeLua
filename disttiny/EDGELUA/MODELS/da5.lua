...
local menu = {
  ...
  saveValues = true,
  {
    ...
    {"M1F", states = gstates1, state = 1, switch = "sf", fn = 6, module = 1},
    {"M1G", states = gstates1, state = 1, switch = "sg", fn = 7, module = 1},
    {"M1H", states = gstates1, state = 1, switch = "sh", fn = 8, module = 1},
  },
  {
    title = "Analog 2",
    ...
    {"M2F", states = gstates1, state = 1, switch = "sf", fn = 6, module = 2},
    {"M2G", states = gstates1, state = 1, switch = "sg", fn = 7, module = 2},
    {"M2H", states = gstates1, state = 1, switch = "sh", fn = 8, module = 2},
  },
  {
    title = "Analog 3",
    ...
    {"M3F", states = gstates1, state = 1, switch = "sf", fn = 6, module = 3},
    {"M3G", states = gstates1, state = 1, switch = "sg", fn = 7, module = 3},
    {"M3H", states = gstates1, state = 1, switch = "sh", fn = 8, module = 3},
  },
  {
    title = "Analog 4",
    ...
    {"M4F", states = gstates1, state = 1, switch = "sf", fn = 6, module = 4},
    {"M4G", states = gstates1, state = 1, switch = "sg", fn = 7, module = 4},
    {"M4H", states = gstates1, state = 1, switch = "sh", fn = 8, module = 4},
  },
  {
    title = "Analog 5",
    ...
    {"M5F", states = gstates1, state = 1, switch = "sf", fn = 6, module = 5},
    {"M5G", states = gstates1, state = 1, switch = "sg", fn = 7, module = 5},
    {"M5H", states = gstates1, state = 1, switch = "sh", fn = 8, module = 5},
  },
}
