...
local menu = {
  ...
  { -- template for export function (via global variable) and virtual functions
    title = "Winden",
    -- backend = 1, -- todo
    {"Winde", states = {"stop", "los", "fest", "Not aus"}, state = 1, switch = "sa", fn = 1, module = 8, export = 1}, -- export
    {"Anker", states = gstates2, state = 1, switch = "sb", fn = 2, module = 8, export = 2},
  ...
  },
  {
    ...
    {"Ton", states = {"T1", "T2", "T3", "T4"}, state = 1, switch = nil, fn = 4, module = 2, export = 3},
    {"Grp", states = {"Sirenen", "Hupen", "Motoren"}, state = 1, switch = nil, fn = 5, module = 2, export = 4},
    {"Sta", states = {"aus", "ein"}, state = 1, switch = nil, fn = 2, module = 3, export = 5, autoreset = 30},
