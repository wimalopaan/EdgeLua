...
local gstates2 = {"stop", "auf", "ab", "NA"};
local gstates3 = {"Pos1", "Pos2", "Pos3", "Pos4"};
...
local menu = {
   { -- template for digital multiswitch RC-MultiSwitch-D @ Address(1)
    ...
    { -- template for export function (via global variable) and virtual functions
        {"Winde", states = gstates2, state = 1, switch = "sa", fn = 1, module = 8, export = 0}, --export
...
return menu, map, exportValues, backend;
